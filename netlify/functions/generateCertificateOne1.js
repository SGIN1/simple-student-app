...
// **تأكد من أن هذا الرابط يشير إلى اسم النطاق الخاص بك**
const NETLIFY_BASE_URL = 'https://youracademy.com'; // استبدل بـاسم نطاقك
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // **إنشاء رابط URL كامل للشهادة الثانية باستخدام الرابط الأنيق**
    const certificateTwoUrl = `${NETLIFY_BASE_URL}/certificate/student/${student._id}`;
    let qrCodeDataUri;
